...
def register(request):
    ...
    return render(request,'users/signup.html',{'title': 'Recruiter Login','u_form':u_form,'w_form':w_form,'uerror':uerror,'werror':werror})
...
def recruiter_login(request):
    ...
    return render(request, 'users/recruiter_login.html',{'title': 'Recruiter Login', 'r_lform':r_lform})
